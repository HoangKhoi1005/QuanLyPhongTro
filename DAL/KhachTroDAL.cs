...
namespace DAL
{
    public class KhachTroDAL
    {
        ...
        {
            string sql = "SELECT KHACHTRO.MAKT, KHACHTRO.HOTEN, KHACHTRO.CCCD, KHACHTRO.NGAYSINH, KHACHTRO.GIOITINH, KHACHTRO.SODT, KHACHTRO.EMAIL, KHACHTRO.DIACHI, KHACHTRO.ANH, KHACHTRO.MOTA FROM KHACHTRO, HOPDONG, KHACHTRO_HOPDONG WHERE KHACHTRO.MAKT = KHACHTRO_HOPDONG.MAKT AND HOPDONG.MAHOPDONG = KHACHTRO_HOPDONG.MAHOPDONG AND HOPDONG.MAPT = '" + maPT + "' AND KHACHTRO.MAKT != HOPDONG.MAKTDAIDIEN AND HOPDONG.TRANGTHAIHOPDONG = 1";
