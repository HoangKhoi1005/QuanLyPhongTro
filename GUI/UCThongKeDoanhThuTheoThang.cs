...
namespace GUI
{
    public partial class UCThongKeDoanhThuTheoThang : UserControl
    {
        ...
        private void loadChartDoanhThu(List<DoanhThuDTO> doanhThuList)
        {
            ...
            {
                var point = series.Points.AddXY(month.Key, month.Value);
                series.Points[point].Label = string.Format("{0:#,##0} VND", month.Value);
            }
        ...
        private void UCThongKeDoanhThuTheoThang_Load(object sender, EventArgs e)
        {
